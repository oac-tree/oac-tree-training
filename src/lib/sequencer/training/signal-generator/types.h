...
#ifndef SEQUENCER_TRAINING_SIGNAL_GENERATOR_TYPES_H_
#define SEQUENCER_TRAINING_SIGNAL_GENERATOR_TYPES_H_
...
#endif  // SEQUENCER_TRAINING_SIGNAL_GENERATOR_TYPES_H_
